...
\subsection{Invariant tracking in the simple quasi-integrable octupole lattice.}
...
\subfigure[Ideal case, $\Delta\nu_x = \Delta\nu_y=0$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux0-nuy0.png}}
\subfigure[$\Delta\nu_x = 0.01, \Delta\nu_y=0$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux001-nuy0.png}}

\subfigure[$\Delta\nu_x = 0.01, \Delta\nu_y=0.01$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux001-nuy001.png}}	
\subfigure[$\Delta\nu_x = 0.1, \Delta\nu_y=0$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux01-nuy0.png}}
	
\subfigure[$\Delta\nu_x = 0.1, \Delta\nu_y=0.1$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux01-nuy01.png}}
\subfigure[$\Delta\nu_x = 0.05, \Delta\nu_y=0.1$]{
	\includegraphics[width=0.45\textwidth]{7.figures/phase-error/XY-nux005-nuy01.png}}
