...
\begin{figure}
	\subfigure[]{\centering
    \includegraphics[width=0.5\textwidth]{8.figures/paper_umer_oct_A.png}
	}
	\subfigure[]{\centering
	\includegraphics[width=0.5\textwidth]{8.figures/paper_umer_oct_nu.png}
	}
...
\begin{figure}[]
   \centering
	\subfigure[]{ \centering
    \includegraphics[width=\textwidth]{8.figures/Ioct=0_F0870_D0870.png}
	}
	\subfigure[]{\centering
    \includegraphics[width=\textwidth]{8.figures/Ioct=2_F0870_D0870.png}
	}
	\subfigure[]{ \centering
    \includegraphics[width=\textwidth]{8.figures/Ioct=4_F0870_D0870.png}
	}
...
\begin{figure}[]
	\subfigure[]{ \centering 
    \includegraphics[width=\textwidth]{8.figures/Ioct=0_F09385_D09435.png}
	}
	\subfigure[]{ \centering
    \includegraphics[width=\textwidth]{8.figures/Ioct=2_F09385_D09435.png}
	}
	\subfigure[]{ \centering
    \includegraphics[width=\textwidth]{8.figures/Ioct=4_F09385_D09435.png}
	}
 	\caption{Invariant $H_N$ for N4 distributed lattice at $\nu_x=4.13$, $\nu_y=4.11$}
    \label{fig:N4invar2}
\end{figure}
...
\begin{figure}[]
	...
	\centering
    \includegraphics[width=0.48\textwidth]{8.figures/pencil_tune_scan_plot_currentspace_Oct0.png}
	}
	\subfigure[N4 lattice tune scan with octupoles powered at 0.5 A]{
	\centering
    \includegraphics[width=0.5\textwidth]{8.figures/pencil_tune_scan_plot_currentspace_Oct5.png}
	}
